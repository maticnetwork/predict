...
import { ASK_ORDER, AUGUR_FEE, BID_ORDER, DEFAULT_GAS, DEFAULT_TRADE_GROUP, MATIC_CHAIN_ID, VALIDATORS, NO_OUTCOME, INVALID_OUTCOME, DEFAULT_RECOMMENDED_TRADE_INTERVAL, DEFAULT_NUM_TICKS } from 'src/constants'
...
//         orderFiller: -(secondOrderAmount * (DEFAULT_NUM_TICKS - secondOrderSharePrice))
//       },
